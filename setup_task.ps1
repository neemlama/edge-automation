# Registers Windows Task Scheduler job: daily 08:00, runs even if you forget.
...
Write-Output "Registered EdgeRewardsDaily at 08:00 daily. Check with: Get-ScheduledTask -TaskName EdgeRewardsDaily"
